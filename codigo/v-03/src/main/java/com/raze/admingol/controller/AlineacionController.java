...
public class AlineacionController {
    ...
    public ResponseEntity<String> showJson(@PathVariable("id") Long id) {
        ...
        try {
            Alineacion alineacion = alineacionService.findAlineacion(id);
            if (alineacion == null) {
    ...
    public ResponseEntity<String> createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        ...
        try {
            ...
            alineacionService.saveAlineacion(alineacion);
    ...
    public ResponseEntity<String> updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        ...
        try {
            Alineacion alineacion = Alineacion.fromJsonToAlineacion(json);
            alineacion.setId(id);
            if (alineacionService.updateAlineacion(alineacion) == null) {
                return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
            }
    ...
    public ResponseEntity<String> deleteFromJson(@PathVariable("id") Long id) {
        ...
        try {
            ...
            alineacionService.deleteAlineacion(alineacion);
            return new ResponseEntity<String>(headers, HttpStatus.OK);
        } catch (Exception e) {
            return new ResponseEntity<String>("{\"ERROR\":"+e.getMessage()+"\"}", headers, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    ...
    public String show(@PathVariable("id") Long id, Model uiModel) {
        ...
        uiModel.addAttribute("alineacion", alineacionService.findAlineacion(id));
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("alineacions", alineacionService.findAlineacionEntries(firstResult, sizeNo));
            float nrOfPages = (float) alineacionService.countAllAlineacions() / sizeNo;
    ...
    public String update(@Valid Alineacion alineacion, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        alineacionService.updateAlineacion(alineacion);
        return "redirect:/alineacions/" + encodeUrlPathSegment(alineacion.getId().toString(), httpServletRequest);
    }

	@RequestMapping(value = "/{id}", params = "form", produces = "text/html")
    public String updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, alineacionService.findAlineacion(id));
        return "alineacions/update";
    }
