...
public class Usuario {
	...
	public static Usuario findUsuariosByUsername(String username) {
        if (username == null) throw new IllegalArgumentException("The activo argument is required");
        EntityManager em = Usuario.entityManager();
	...
	public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("empresa", "nombre", "apellidoPaterno", "apellidoMaterno", "fechaNacimiento", "domicilio", "telefono", "celular", "username", "password", "rol", "numeroIntentos", "activo", "usuario", "fechaCreacion", "fechaModificacion");
