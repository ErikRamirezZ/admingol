...
privileged aspect StatusPartido_Roo_Finder {
    
    public static Long StatusPartido.countFindStatusPartidoesByActivo(Boolean activo) {
    ...
    public static TypedQuery<StatusPartido> StatusPartido.findStatusPartidoesByActivo(Boolean activo) {
        if (activo == null) throw new IllegalArgumentException("The activo argument is required");
        EntityManager em = StatusPartido.entityManager();
    ...
    public static TypedQuery<StatusPartido> StatusPartido.findStatusPartidoesByActivo(Boolean activo, String sortFieldName, String sortOrder) {
        if (activo == null) throw new IllegalArgumentException("The activo argument is required");
        EntityManager em = StatusPartido.entityManager();
