...
public class EquipoIntegrationTest {
    ...
    public void testFindEquipoEntries() {
        ...
        List<Equipo> result = Equipo.findEquipoEntries(firstResult, maxResults);
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'Equipo' with identifier '" + id + "'", Equipo.findEquipo(id));
    }
}
