...
import com.raze.admingol.domain.JugadorIntegrationTest;
...
privileged aspect JugadorIntegrationTest_Roo_IntegrationTest {
    
    declare @type: JugadorIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: JugadorIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: JugadorIntegrationTest: @Transactional;
    
    @Autowired
    JugadorDataOnDemand JugadorIntegrationTest.dod;
    
    @Test
    public void JugadorIntegrationTest.testCountJugadors() {
    ...
    @Test
    public void JugadorIntegrationTest.testFindJugador() {
    ...
    @Test
    public void JugadorIntegrationTest.testFindAllJugadors() {
        Assert.assertNotNull("Data on demand for 'Jugador' failed to initialize correctly", dod.getRandomJugador());
        long count = Jugador.countJugadors();
    ...
    @Test
    public void JugadorIntegrationTest.testFindJugadorEntries() {
        Assert.assertNotNull("Data on demand for 'Jugador' failed to initialize correctly", dod.getRandomJugador());
        long count = Jugador.countJugadors();
    ...
    @Test
    public void JugadorIntegrationTest.testFlush() {
        Jugador obj = dod.getRandomJugador();
        Assert.assertNotNull("Data on demand for 'Jugador' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Jugador' failed to provide an identifier", id);
    ...
    @Test
    public void JugadorIntegrationTest.testMergeUpdate() {
        Jugador obj = dod.getRandomJugador();
        Assert.assertNotNull("Data on demand for 'Jugador' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Jugador' failed to provide an identifier", id);
    ...
    @Test
    public void JugadorIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Jugador' failed to initialize correctly", dod.getRandomJugador());
    ...
    @Test
    public void JugadorIntegrationTest.testRemove() {
        Jugador obj = dod.getRandomJugador();
        Assert.assertNotNull("Data on demand for 'Jugador' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Jugador' failed to provide an identifier", id);
