...
import com.raze.admingol.domain.CedulaPartidoIntegrationTest;
...
privileged aspect CedulaPartidoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: CedulaPartidoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: CedulaPartidoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: CedulaPartidoIntegrationTest: @Transactional;
    
    @Autowired
    CedulaPartidoDataOnDemand CedulaPartidoIntegrationTest.dod;
    
    @Test
    public void CedulaPartidoIntegrationTest.testCountCedulaPartidoes() {
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testFindCedulaPartido() {
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testFindAllCedulaPartidoes() {
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to initialize correctly", dod.getRandomCedulaPartido());
        long count = CedulaPartido.countCedulaPartidoes();
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testFindCedulaPartidoEntries() {
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to initialize correctly", dod.getRandomCedulaPartido());
        long count = CedulaPartido.countCedulaPartidoes();
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testFlush() {
        CedulaPartido obj = dod.getRandomCedulaPartido();
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to provide an identifier", id);
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testMergeUpdate() {
        CedulaPartido obj = dod.getRandomCedulaPartido();
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to provide an identifier", id);
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to initialize correctly", dod.getRandomCedulaPartido());
    ...
    @Test
    public void CedulaPartidoIntegrationTest.testRemove() {
        CedulaPartido obj = dod.getRandomCedulaPartido();
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'CedulaPartido' failed to provide an identifier", id);
