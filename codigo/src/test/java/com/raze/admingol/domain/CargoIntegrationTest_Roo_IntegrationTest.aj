...
import com.raze.admingol.domain.CargoIntegrationTest;
...
privileged aspect CargoIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void CargoIntegrationTest.testCountCargoes() {
    ...
    @Test
    public void CargoIntegrationTest.testFlush() {
        Cargo obj = dod.getRandomCargo();
        Assert.assertNotNull("Data on demand for 'Cargo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Cargo' failed to provide an identifier", id);
    ...
    @Test
    public void CargoIntegrationTest.testMergeUpdate() {
        Cargo obj = dod.getRandomCargo();
        Assert.assertNotNull("Data on demand for 'Cargo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Cargo' failed to provide an identifier", id);
    ...
    @Test
    public void CargoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Cargo' failed to initialize correctly", dod.getRandomCargo());
    ...
    @Test
    public void CargoIntegrationTest.testRemove() {
        Cargo obj = dod.getRandomCargo();
        Assert.assertNotNull("Data on demand for 'Cargo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Cargo' failed to provide an identifier", id);
