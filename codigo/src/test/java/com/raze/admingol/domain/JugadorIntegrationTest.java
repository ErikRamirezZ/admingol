...
@Transactional
@Configurable
@RooIntegrationTest(entity = Jugador.class)
public class JugadorIntegrationTest {
    ...
    public void testFindJugadorEntries() {
        ...
        List<Jugador> result = Jugador.findJugadorEntries(firstResult, maxResults);
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'Jugador' with identifier '" + id + "'", Jugador.findJugador(id));
    }
}
