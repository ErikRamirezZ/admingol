...
import com.raze.admingol.domain.EquipoIntegrationTest;
...
privileged aspect EquipoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: EquipoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: EquipoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: EquipoIntegrationTest: @Transactional;
    
    @Autowired
    EquipoDataOnDemand EquipoIntegrationTest.dod;
    
    @Test
    public void EquipoIntegrationTest.testCountEquipoes() {
    ...
    @Test
    public void EquipoIntegrationTest.testFindEquipo() {
    ...
    @Test
    public void EquipoIntegrationTest.testFindAllEquipoes() {
        Assert.assertNotNull("Data on demand for 'Equipo' failed to initialize correctly", dod.getRandomEquipo());
        long count = Equipo.countEquipoes();
    ...
    @Test
    public void EquipoIntegrationTest.testFindEquipoEntries() {
        Assert.assertNotNull("Data on demand for 'Equipo' failed to initialize correctly", dod.getRandomEquipo());
        long count = Equipo.countEquipoes();
    ...
    @Test
    public void EquipoIntegrationTest.testFlush() {
        Equipo obj = dod.getRandomEquipo();
        Assert.assertNotNull("Data on demand for 'Equipo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Equipo' failed to provide an identifier", id);
    ...
    @Test
    public void EquipoIntegrationTest.testMergeUpdate() {
        Equipo obj = dod.getRandomEquipo();
        Assert.assertNotNull("Data on demand for 'Equipo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Equipo' failed to provide an identifier", id);
    ...
    @Test
    public void EquipoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Equipo' failed to initialize correctly", dod.getRandomEquipo());
    ...
    @Test
    public void EquipoIntegrationTest.testRemove() {
        Equipo obj = dod.getRandomEquipo();
        Assert.assertNotNull("Data on demand for 'Equipo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Equipo' failed to provide an identifier", id);
