...
import com.raze.admingol.domain.PartidoIntegrationTest;
...
privileged aspect PartidoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: PartidoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: PartidoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: PartidoIntegrationTest: @Transactional;
    
    @Autowired
    PartidoDataOnDemand PartidoIntegrationTest.dod;
    
    @Test
    public void PartidoIntegrationTest.testCountPartidoes() {
    ...
    @Test
    public void PartidoIntegrationTest.testFindPartido() {
    ...
    @Test
    public void PartidoIntegrationTest.testFindAllPartidoes() {
        Assert.assertNotNull("Data on demand for 'Partido' failed to initialize correctly", dod.getRandomPartido());
        long count = Partido.countPartidoes();
    ...
    @Test
    public void PartidoIntegrationTest.testFindPartidoEntries() {
        Assert.assertNotNull("Data on demand for 'Partido' failed to initialize correctly", dod.getRandomPartido());
        long count = Partido.countPartidoes();
    ...
    @Test
    public void PartidoIntegrationTest.testFlush() {
        Partido obj = dod.getRandomPartido();
        Assert.assertNotNull("Data on demand for 'Partido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Partido' failed to provide an identifier", id);
    ...
    @Test
    public void PartidoIntegrationTest.testMergeUpdate() {
        Partido obj = dod.getRandomPartido();
        Assert.assertNotNull("Data on demand for 'Partido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Partido' failed to provide an identifier", id);
    ...
    @Test
    public void PartidoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Partido' failed to initialize correctly", dod.getRandomPartido());
    ...
    @Test
    public void PartidoIntegrationTest.testRemove() {
        Partido obj = dod.getRandomPartido();
        Assert.assertNotNull("Data on demand for 'Partido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Partido' failed to provide an identifier", id);
