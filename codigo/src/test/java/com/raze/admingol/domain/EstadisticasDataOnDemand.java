...
@Component
@Configurable
@RooDataOnDemand(entity = Estadisticas.class)
public class EstadisticasDataOnDemand {
	...
	@Autowired
    AccionDataOnDemand accionDataOnDemand;
	...
	public void setAccion(Estadisticas obj, int index) {
        Accion accion = accionDataOnDemand.getRandomAccion();
	...
	public void init() {
        int from = 0;
        int to = 10;
        data = Estadisticas.findEstadisticasEntries(from, to);
        if (data == null) {
