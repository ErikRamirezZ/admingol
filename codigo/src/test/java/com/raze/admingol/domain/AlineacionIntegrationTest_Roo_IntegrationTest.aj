...
import com.raze.admingol.domain.AlineacionIntegrationTest;
...
privileged aspect AlineacionIntegrationTest_Roo_IntegrationTest {
    
    declare @type: AlineacionIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: AlineacionIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: AlineacionIntegrationTest: @Transactional;
    
    @Autowired
    AlineacionDataOnDemand AlineacionIntegrationTest.dod;
    
    @Test
    public void AlineacionIntegrationTest.testCountAlineacions() {
    ...
    @Test
    public void AlineacionIntegrationTest.testFindAlineacion() {
    ...
    @Test
    public void AlineacionIntegrationTest.testFindAllAlineacions() {
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to initialize correctly", dod.getRandomAlineacion());
        long count = Alineacion.countAlineacions();
    ...
    @Test
    public void AlineacionIntegrationTest.testFindAlineacionEntries() {
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to initialize correctly", dod.getRandomAlineacion());
        long count = Alineacion.countAlineacions();
    ...
    @Test
    public void AlineacionIntegrationTest.testFlush() {
        Alineacion obj = dod.getRandomAlineacion();
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to provide an identifier", id);
    ...
    @Test
    public void AlineacionIntegrationTest.testMergeUpdate() {
        Alineacion obj = dod.getRandomAlineacion();
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to provide an identifier", id);
    ...
    @Test
    public void AlineacionIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to initialize correctly", dod.getRandomAlineacion());
    ...
    @Test
    public void AlineacionIntegrationTest.testRemove() {
        Alineacion obj = dod.getRandomAlineacion();
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Alineacion' failed to provide an identifier", id);
