...
privileged aspect TorneoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TorneoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TorneoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TorneoIntegrationTest: @Transactional;
    
    @Autowired
    TorneoDataOnDemand TorneoIntegrationTest.dod;
    
    @Test
    public void TorneoIntegrationTest.testCountTorneos() {
    ...
    @Test
    public void TorneoIntegrationTest.testFindTorneo() {
    ...
    @Test
    public void TorneoIntegrationTest.testFindAllTorneos() {
        Assert.assertNotNull("Data on demand for 'Torneo' failed to initialize correctly", dod.getRandomTorneo());
        long count = Torneo.countTorneos();
    ...
    @Test
    public void TorneoIntegrationTest.testFindTorneoEntries() {
        Assert.assertNotNull("Data on demand for 'Torneo' failed to initialize correctly", dod.getRandomTorneo());
        long count = Torneo.countTorneos();
    ...
    @Test
    public void TorneoIntegrationTest.testFlush() {
        Torneo obj = dod.getRandomTorneo();
        Assert.assertNotNull("Data on demand for 'Torneo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Torneo' failed to provide an identifier", id);
    ...
    @Test
    public void TorneoIntegrationTest.testMergeUpdate() {
        Torneo obj = dod.getRandomTorneo();
        Assert.assertNotNull("Data on demand for 'Torneo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Torneo' failed to provide an identifier", id);
    ...
    @Test
    public void TorneoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Torneo' failed to initialize correctly", dod.getRandomTorneo());
    ...
    @Test
    public void TorneoIntegrationTest.testRemove() {
        Torneo obj = dod.getRandomTorneo();
        Assert.assertNotNull("Data on demand for 'Torneo' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Torneo' failed to provide an identifier", id);
