...
import com.raze.admingol.catalog.FechaVencimientoTCIntegrationTest;
...
privileged aspect FechaVencimientoTCIntegrationTest_Roo_IntegrationTest {
    
    declare @type: FechaVencimientoTCIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: FechaVencimientoTCIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: FechaVencimientoTCIntegrationTest: @Transactional;
    
    @Autowired
    FechaVencimientoTCDataOnDemand FechaVencimientoTCIntegrationTest.dod;
    
    @Test
    public void FechaVencimientoTCIntegrationTest.testCountFechaVencimientoTCs() {
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testFindFechaVencimientoTC() {
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testFindAllFechaVencimientoTCs() {
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to initialize correctly", dod.getRandomFechaVencimientoTC());
        long count = FechaVencimientoTC.countFechaVencimientoTCs();
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testFindFechaVencimientoTCEntries() {
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to initialize correctly", dod.getRandomFechaVencimientoTC());
        long count = FechaVencimientoTC.countFechaVencimientoTCs();
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testFlush() {
        FechaVencimientoTC obj = dod.getRandomFechaVencimientoTC();
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to provide an identifier", id);
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testMergeUpdate() {
        FechaVencimientoTC obj = dod.getRandomFechaVencimientoTC();
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to provide an identifier", id);
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to initialize correctly", dod.getRandomFechaVencimientoTC());
    ...
    @Test
    public void FechaVencimientoTCIntegrationTest.testRemove() {
        FechaVencimientoTC obj = dod.getRandomFechaVencimientoTC();
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'FechaVencimientoTC' failed to provide an identifier", id);
