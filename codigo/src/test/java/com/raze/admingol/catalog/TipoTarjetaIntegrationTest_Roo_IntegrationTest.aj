...
import com.raze.admingol.catalog.TipoTarjetaIntegrationTest;
...
privileged aspect TipoTarjetaIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TipoTarjetaIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TipoTarjetaIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TipoTarjetaIntegrationTest: @Transactional;
    
    @Autowired
    TipoTarjetaDataOnDemand TipoTarjetaIntegrationTest.dod;
    
    @Test
    public void TipoTarjetaIntegrationTest.testCountTipoTarjetas() {
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testFindTipoTarjeta() {
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testFindAllTipoTarjetas() {
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to initialize correctly", dod.getRandomTipoTarjeta());
        long count = TipoTarjeta.countTipoTarjetas();
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testFindTipoTarjetaEntries() {
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to initialize correctly", dod.getRandomTipoTarjeta());
        long count = TipoTarjeta.countTipoTarjetas();
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testFlush() {
        TipoTarjeta obj = dod.getRandomTipoTarjeta();
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to provide an identifier", id);
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testMergeUpdate() {
        TipoTarjeta obj = dod.getRandomTipoTarjeta();
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to provide an identifier", id);
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to initialize correctly", dod.getRandomTipoTarjeta());
    ...
    @Test
    public void TipoTarjetaIntegrationTest.testRemove() {
        TipoTarjeta obj = dod.getRandomTipoTarjeta();
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoTarjeta' failed to provide an identifier", id);
