...
privileged aspect StatusEquipoJugadorIntegrationTest_Roo_IntegrationTest {
    
    declare @type: StatusEquipoJugadorIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: StatusEquipoJugadorIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: StatusEquipoJugadorIntegrationTest: @Transactional;
    
    @Autowired
    StatusEquipoJugadorDataOnDemand StatusEquipoJugadorIntegrationTest.dod;
    
    @Test
    public void StatusEquipoJugadorIntegrationTest.testCountStatusEquipoJugadors() {
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testFindStatusEquipoJugador() {
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testFindAllStatusEquipoJugadors() {
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to initialize correctly", dod.getRandomStatusEquipoJugador());
        long count = StatusEquipoJugador.countStatusEquipoJugadors();
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testFindStatusEquipoJugadorEntries() {
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to initialize correctly", dod.getRandomStatusEquipoJugador());
        long count = StatusEquipoJugador.countStatusEquipoJugadors();
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testFlush() {
        StatusEquipoJugador obj = dod.getRandomStatusEquipoJugador();
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to provide an identifier", id);
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testMergeUpdate() {
        StatusEquipoJugador obj = dod.getRandomStatusEquipoJugador();
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to provide an identifier", id);
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to initialize correctly", dod.getRandomStatusEquipoJugador());
    ...
    @Test
    public void StatusEquipoJugadorIntegrationTest.testRemove() {
        StatusEquipoJugador obj = dod.getRandomStatusEquipoJugador();
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusEquipoJugador' failed to provide an identifier", id);
