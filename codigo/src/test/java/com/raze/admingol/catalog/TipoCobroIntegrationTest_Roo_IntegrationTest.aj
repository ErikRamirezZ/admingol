...
privileged aspect TipoCobroIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TipoCobroIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TipoCobroIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TipoCobroIntegrationTest: @Transactional;
    
    @Autowired
    TipoCobroDataOnDemand TipoCobroIntegrationTest.dod;
    
    @Test
    public void TipoCobroIntegrationTest.testCountTipoCobroes() {
    ...
    @Test
    public void TipoCobroIntegrationTest.testFindTipoCobro() {
    ...
    @Test
    public void TipoCobroIntegrationTest.testFindAllTipoCobroes() {
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to initialize correctly", dod.getRandomTipoCobro());
        long count = TipoCobro.countTipoCobroes();
    ...
    @Test
    public void TipoCobroIntegrationTest.testFindTipoCobroEntries() {
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to initialize correctly", dod.getRandomTipoCobro());
        long count = TipoCobro.countTipoCobroes();
    ...
    @Test
    public void TipoCobroIntegrationTest.testFlush() {
        TipoCobro obj = dod.getRandomTipoCobro();
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to provide an identifier", id);
    ...
    @Test
    public void TipoCobroIntegrationTest.testMergeUpdate() {
        TipoCobro obj = dod.getRandomTipoCobro();
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to provide an identifier", id);
    ...
    @Test
    public void TipoCobroIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to initialize correctly", dod.getRandomTipoCobro());
    ...
    @Test
    public void TipoCobroIntegrationTest.testRemove() {
        TipoCobro obj = dod.getRandomTipoCobro();
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoCobro' failed to provide an identifier", id);
