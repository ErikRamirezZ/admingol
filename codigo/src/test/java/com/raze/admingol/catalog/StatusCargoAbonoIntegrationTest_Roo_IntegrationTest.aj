...
import com.raze.admingol.catalog.StatusCargoAbonoIntegrationTest;
...
privileged aspect StatusCargoAbonoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: StatusCargoAbonoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: StatusCargoAbonoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: StatusCargoAbonoIntegrationTest: @Transactional;
    
    @Autowired
    StatusCargoAbonoDataOnDemand StatusCargoAbonoIntegrationTest.dod;
    
    @Test
    public void StatusCargoAbonoIntegrationTest.testCountStatusCargoAbonoes() {
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testFindStatusCargoAbono() {
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testFindAllStatusCargoAbonoes() {
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to initialize correctly", dod.getRandomStatusCargoAbono());
        long count = StatusCargoAbono.countStatusCargoAbonoes();
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testFindStatusCargoAbonoEntries() {
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to initialize correctly", dod.getRandomStatusCargoAbono());
        long count = StatusCargoAbono.countStatusCargoAbonoes();
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testFlush() {
        StatusCargoAbono obj = dod.getRandomStatusCargoAbono();
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to provide an identifier", id);
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testMergeUpdate() {
        StatusCargoAbono obj = dod.getRandomStatusCargoAbono();
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to provide an identifier", id);
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to initialize correctly", dod.getRandomStatusCargoAbono());
    ...
    @Test
    public void StatusCargoAbonoIntegrationTest.testRemove() {
        StatusCargoAbono obj = dod.getRandomStatusCargoAbono();
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusCargoAbono' failed to provide an identifier", id);
