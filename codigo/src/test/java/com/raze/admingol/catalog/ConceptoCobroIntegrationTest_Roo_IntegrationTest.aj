...
import com.raze.admingol.catalog.ConceptoCobroIntegrationTest;
...
privileged aspect ConceptoCobroIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ConceptoCobroIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ConceptoCobroIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ConceptoCobroIntegrationTest: @Transactional;
    
    @Autowired
    ConceptoCobroDataOnDemand ConceptoCobroIntegrationTest.dod;
    
    @Test
    public void ConceptoCobroIntegrationTest.testCountConceptoCobroes() {
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testFindConceptoCobro() {
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testFindAllConceptoCobroes() {
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to initialize correctly", dod.getRandomConceptoCobro());
        long count = ConceptoCobro.countConceptoCobroes();
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testFindConceptoCobroEntries() {
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to initialize correctly", dod.getRandomConceptoCobro());
        long count = ConceptoCobro.countConceptoCobroes();
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testFlush() {
        ConceptoCobro obj = dod.getRandomConceptoCobro();
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to provide an identifier", id);
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testMergeUpdate() {
        ConceptoCobro obj = dod.getRandomConceptoCobro();
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to provide an identifier", id);
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to initialize correctly", dod.getRandomConceptoCobro());
    ...
    @Test
    public void ConceptoCobroIntegrationTest.testRemove() {
        ConceptoCobro obj = dod.getRandomConceptoCobro();
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ConceptoCobro' failed to provide an identifier", id);
