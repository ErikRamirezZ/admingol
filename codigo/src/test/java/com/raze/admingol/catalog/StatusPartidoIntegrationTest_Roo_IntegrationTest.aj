...
privileged aspect StatusPartidoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: StatusPartidoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: StatusPartidoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: StatusPartidoIntegrationTest: @Transactional;
    
    @Autowired
    StatusPartidoDataOnDemand StatusPartidoIntegrationTest.dod;
    
    @Test
    public void StatusPartidoIntegrationTest.testCountStatusPartidoes() {
    ...
    @Test
    public void StatusPartidoIntegrationTest.testFindStatusPartido() {
    ...
    @Test
    public void StatusPartidoIntegrationTest.testFindAllStatusPartidoes() {
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to initialize correctly", dod.getRandomStatusPartido());
        long count = StatusPartido.countStatusPartidoes();
    ...
    @Test
    public void StatusPartidoIntegrationTest.testFindStatusPartidoEntries() {
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to initialize correctly", dod.getRandomStatusPartido());
        long count = StatusPartido.countStatusPartidoes();
    ...
    @Test
    public void StatusPartidoIntegrationTest.testFlush() {
        StatusPartido obj = dod.getRandomStatusPartido();
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to provide an identifier", id);
    ...
    @Test
    public void StatusPartidoIntegrationTest.testMergeUpdate() {
        StatusPartido obj = dod.getRandomStatusPartido();
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to provide an identifier", id);
    ...
    @Test
    public void StatusPartidoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to initialize correctly", dod.getRandomStatusPartido());
    ...
    @Test
    public void StatusPartidoIntegrationTest.testRemove() {
        StatusPartido obj = dod.getRandomStatusPartido();
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StatusPartido' failed to provide an identifier", id);
