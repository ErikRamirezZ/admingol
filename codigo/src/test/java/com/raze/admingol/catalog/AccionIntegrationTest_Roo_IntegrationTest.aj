...
import com.raze.admingol.catalog.AccionIntegrationTest;
...
privileged aspect AccionIntegrationTest_Roo_IntegrationTest {
    
    declare @type: AccionIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: AccionIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: AccionIntegrationTest: @Transactional;
    
    @Autowired
    AccionDataOnDemand AccionIntegrationTest.dod;
    
    @Test
    public void AccionIntegrationTest.testCountAccions() {
    ...
    @Test
    public void AccionIntegrationTest.testFindAccion() {
    ...
    @Test
    public void AccionIntegrationTest.testFindAllAccions() {
        Assert.assertNotNull("Data on demand for 'Accion' failed to initialize correctly", dod.getRandomAccion());
        long count = Accion.countAccions();
    ...
    @Test
    public void AccionIntegrationTest.testFindAccionEntries() {
        Assert.assertNotNull("Data on demand for 'Accion' failed to initialize correctly", dod.getRandomAccion());
        long count = Accion.countAccions();
    ...
    @Test
    public void AccionIntegrationTest.testFlush() {
        Accion obj = dod.getRandomAccion();
        Assert.assertNotNull("Data on demand for 'Accion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Accion' failed to provide an identifier", id);
    ...
    @Test
    public void AccionIntegrationTest.testMergeUpdate() {
        Accion obj = dod.getRandomAccion();
        Assert.assertNotNull("Data on demand for 'Accion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Accion' failed to provide an identifier", id);
    ...
    @Test
    public void AccionIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'Accion' failed to initialize correctly", dod.getRandomAccion());
    ...
    @Test
    public void AccionIntegrationTest.testRemove() {
        Accion obj = dod.getRandomAccion();
        Assert.assertNotNull("Data on demand for 'Accion' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Accion' failed to provide an identifier", id);
