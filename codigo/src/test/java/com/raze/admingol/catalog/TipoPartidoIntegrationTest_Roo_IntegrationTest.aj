...
privileged aspect TipoPartidoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TipoPartidoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TipoPartidoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TipoPartidoIntegrationTest: @Transactional;
    
    @Autowired
    TipoPartidoDataOnDemand TipoPartidoIntegrationTest.dod;
    
    @Test
    public void TipoPartidoIntegrationTest.testCountTipoPartidoes() {
    ...
    @Test
    public void TipoPartidoIntegrationTest.testFindTipoPartido() {
    ...
    @Test
    public void TipoPartidoIntegrationTest.testFindAllTipoPartidoes() {
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to initialize correctly", dod.getRandomTipoPartido());
        long count = TipoPartido.countTipoPartidoes();
    ...
    @Test
    public void TipoPartidoIntegrationTest.testFindTipoPartidoEntries() {
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to initialize correctly", dod.getRandomTipoPartido());
        long count = TipoPartido.countTipoPartidoes();
    ...
    @Test
    public void TipoPartidoIntegrationTest.testFlush() {
        TipoPartido obj = dod.getRandomTipoPartido();
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to provide an identifier", id);
    ...
    @Test
    public void TipoPartidoIntegrationTest.testMergeUpdate() {
        TipoPartido obj = dod.getRandomTipoPartido();
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to provide an identifier", id);
    ...
    @Test
    public void TipoPartidoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to initialize correctly", dod.getRandomTipoPartido());
    ...
    @Test
    public void TipoPartidoIntegrationTest.testRemove() {
        TipoPartido obj = dod.getRandomTipoPartido();
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TipoPartido' failed to provide an identifier", id);
