...
import com.raze.admingol.catalog.DiasJuegoIntegrationTest;
...
privileged aspect DiasJuegoIntegrationTest_Roo_IntegrationTest {
    
    declare @type: DiasJuegoIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: DiasJuegoIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: DiasJuegoIntegrationTest: @Transactional;
    
    @Autowired
    DiasJuegoDataOnDemand DiasJuegoIntegrationTest.dod;
    
    @Test
    public void DiasJuegoIntegrationTest.testCountDiasJuegoes() {
    ...
    @Test
    public void DiasJuegoIntegrationTest.testFindDiasJuego() {
    ...
    @Test
    public void DiasJuegoIntegrationTest.testFindAllDiasJuegoes() {
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to initialize correctly", dod.getRandomDiasJuego());
        long count = DiasJuego.countDiasJuegoes();
    ...
    @Test
    public void DiasJuegoIntegrationTest.testFindDiasJuegoEntries() {
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to initialize correctly", dod.getRandomDiasJuego());
        long count = DiasJuego.countDiasJuegoes();
    ...
    @Test
    public void DiasJuegoIntegrationTest.testFlush() {
        DiasJuego obj = dod.getRandomDiasJuego();
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to provide an identifier", id);
    ...
    @Test
    public void DiasJuegoIntegrationTest.testMergeUpdate() {
        DiasJuego obj = dod.getRandomDiasJuego();
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to provide an identifier", id);
    ...
    @Test
    public void DiasJuegoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to initialize correctly", dod.getRandomDiasJuego());
    ...
    @Test
    public void DiasJuegoIntegrationTest.testRemove() {
        DiasJuego obj = dod.getRandomDiasJuego();
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'DiasJuego' failed to provide an identifier", id);
