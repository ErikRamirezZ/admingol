...
import com.raze.admingol.catalog.MetodoPagoIntegrationTest;
...
privileged aspect MetodoPagoIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void MetodoPagoIntegrationTest.testCountMetodoPagoes() {
    ...
    @Test
    public void MetodoPagoIntegrationTest.testFlush() {
        MetodoPago obj = dod.getRandomMetodoPago();
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to provide an identifier", id);
    ...
    @Test
    public void MetodoPagoIntegrationTest.testMergeUpdate() {
        MetodoPago obj = dod.getRandomMetodoPago();
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to provide an identifier", id);
    ...
    @Test
    public void MetodoPagoIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to initialize correctly", dod.getRandomMetodoPago());
    ...
    @Test
    public void MetodoPagoIntegrationTest.testRemove() {
        MetodoPago obj = dod.getRandomMetodoPago();
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'MetodoPago' failed to provide an identifier", id);
